                ...
                <div class="card-body">
                    <form action="{{ route('menu.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" class="form-control" placeholder="Masukan Nama Kategori">
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="link" value="{{ old('link') }}" class="form-control" placeholder="Masukan Nama Kategori">
                            @if ($errors->has('link'))
                                <small class="text-danger">Kategori harus diisi</small>
                            @endif
                        </div>
