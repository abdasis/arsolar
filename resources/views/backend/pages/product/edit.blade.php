                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_produk" id="nama_produk"
                                ...
                                value="{{ $produk->nama_produk }}" placeholder="Masukan Nama Product" required autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="editor" class="form-class"
                                name="deskripsi_produk">{{ $produk->diskripsi }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_produk_eng" id="nama_produk_eng"
                                ...
                                value="{{ $produk_eng->nama_produk }}" placeholder="Input Product Name" required autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="editor" class="form-class"
                                name="diskripsi_produk_eng">{{ $produk_eng->diskripsi }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="status" id="inputState" class="form-control">
                                ...
                                <option {{ $produk->status_produk == 'Draft' ? 'selected' : '' }}>Draft</option>
                                <option {{ $produk->status_produk == 'Publish' ? 'selected' : '' }}>Publish</option>
                                <option {{ $produk->status_produk == 'Featured' ? 'selected' : '' }}>Featured</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori" id="inputState" class="form-control">
                                ...
                                <option {{ $category->nama_kategori == $produk->kategori ? 'selected' : '' }}>
